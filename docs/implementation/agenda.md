...
- **🧘 Morning** — Intentions, focus for the day
- **🔴 Schedule** — Fixed appointments with times
...
## 🧘 Morning
Focus today: Quarterly report finalisieren.

## 🔴 Schedule
- 09:00 Standup
- 14:00 Client call (Project Alpha)
- 16:30 Kinder abholen

## 🟠 Tasks
- [ ] Quarterly report fertigstellen
- [x] Email an X wegen Meeting
- [ ] PR #42 reviewen

## Notes
<!-- 10:15 -->
Call mit Client lief gut. Follow-up nächste Woche.

## Evening
Guter Tag. Report noch offen — auf morgen verschieben.
```
...
HTML comments in Daily.md are noticed and processed:

```markdown
- [ ] Report schreiben #deadline-2025-03-28  <!-- verschoben auf nächste Woche -->
```

outheis sees this annotation and can act on it (e.g., update deadline, note in Evening).
...
**Relay (ou)** routes schedule questions to Agenda and offers the `refresh_agenda` tool for manual updates.
