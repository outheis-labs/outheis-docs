...
**Facets** are derived exclusively from the `#facet-*` tags present in Shadow.md — no separate definition or configuration needed. Colors are assigned dynamically per facet ID.
